...
export function LoadingSpinner({ hasApiKey, hasSupabase, loadingProgress }: LoadingSpinnerProps) {
  const metrics = [
      ...
      <div className="bg-white rounded-3xl shadow-2xl border border-gray-200 p-8 max-w-lg mx-auto">
        <div className="text-center">
          ...
          <h3 className="text-2xl font-bold text-gray-900 mb-2">
            {hasApiKey ? 'Running Lighthouse Analysis' : 'Generating Performance Report'}
          </h3>
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-xl">
            <p className="text-sm text-blue-800">
              <span className="font-medium">💡 Tip:</span> {hasApiKey 
